...
return [
    ...
    */
    ...
    'route' => [
         ...
         */
        'uri' => env('LIGHTHOUSE_URI', '/graphql'),
        ...
        'domain' => env('LIGHTHOUSE_DOMAIN', '127.0.0.1'),
        /*
         *
    ...
    */
    ...
    'namespaces' => [
        ...
        'mutations' => [
            ...
            'App\\GraphQL\\Mutations\\Group',
            'App\\GraphQL\\Mutations\\Population',
            'App\\GraphQL\\Mutations\\Quizz',
            'App\\GraphQL\\Mutations\\Question',
            'App\\GraphQL\\Mutations\\Category',
            'App\\GraphQL\\Mutations\\User',
            'App\\GraphQL\\Mutations\\Featured',
            'App\\GraphQL\\Mutations\\Author',
        ...
        'directives' => ['App\\GraphQL\\Directives', 'App\\GraphQL\\Directives\\Validations'],
    ],
    ...
    */
    ...
    'error_handlers' => [
        ...
        App\GraphQL\ErrorHandlers\RethrowRenderLessExceptions::class
    ],
