...
import { showAuthor } from '../../services/author/authorActions'
...
class AuthorDetail extends Component {
  ...
  componentDidMount () {
    this.props.authorActions.showAuthor(this.props.match.params.id)
  }
    ...
    return (
      <div className='p-5 w-100 mt-60'>
        ...
        <Breadcrumbs aria-label='breadcrumb' className='w-100 mb-4'>
          ...
          <Link color='inherit' to='/author/authors'>
            Authors
          </Link>
        ...
        {this.state.loading ? (
          ...
          <div noValidate autoComplete='off' className='authorDetail'>
            <div className='d-flex justify-content-between mb-4'>
              <h4>Author: {this.props.author.author.name}</h4>
              <Button
                variant='contained'
                color='primary'
                component='span'
                ...
                component={Link}
                className=''
                to={'/author/edit/' + this.props.match.params.id}
              >
            ...
            <div>
              <div className='row w-100'>
                <div className='col-md-6'>
                  {this.props.author.pic && 
                    <div className="row mb-3">
                      <img src={this.props.author.pic} className='w-50' />
                    </div>
                  }
                  ...
                  <div className='row d-flex mb-3'>
                    ...
                    <div className='w-50 col-md'>
                      {this.props.author.author.function}
                    </div>
                  </div>
                  <div className='row d-flex mb-3'>
                    ...
                    <div className='w-50 col-md'>
                      {this.props.author.author.description}
                    </div>
                  </div>
                  <div className='row d-flex mb-3'>
                    <div className='font-weight-bold w-50 col-md'>FB Link</div>
                    <div className='w-50 col-md'>
                      {this.props.author.author.fb_link != 'None' ? (
                        <a href={this.props.author.author.fb_link}>Go To</a>
                      ) : (
                        <a>No Link</a>
                      )}
                    </div>
                  ...
                  <div className='row d-flex mb-3'>
                    ...
                    <div className='w-50 col-md'>
                      {this.props.author.author.twitter_link != 'None' ? (
                        <a href={this.props.author.author.twitter_link}>
                          Go To
                        </a>
                      ) : (
                        <a>No Link</a>
                  ...
                  <div className='row d-flex mb-3'>
                    ...
                    <div className='w-50 col-md'>
                      {this.props.author.author.website_link != 'None' ? (
                        <a href={this.props.author.author.website_link}>
                          Go To
                        </a>
                      ) : (
                        <a>No Link</a>
                ...
                <div className='col-md-6'>
                  <Grid item xs={12} className='w-100'>
                    <MaterialTable
                      ...
                      fixedHeader={false}
                      data={this.props.author.quizzes}
                      icons={tableIcons}
                    />
                  </Grid>
                  <Grid item xs={12} className='w-100 mt-4'>
                    <MaterialTable
                      ...
                      fixedHeader={false}
                      data={this.props.author.questions}
                      icons={tableIcons}
                    />
                  </Grid>
                </div>
...
export default connect(
  state => ({
    ...
    status: state.default.services.author.status
  }),
  dispatch => ({
    authorActions: bindActionCreators(
      {
        showAuthor
      },
      dispatch
