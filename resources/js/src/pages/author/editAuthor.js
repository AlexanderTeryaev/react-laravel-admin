...
import { updateAuthor, editAuthor } from '../../services/author/authorActions'
...
class EditAuthor extends Component {
  ...
  componentDidMount () {
    this.props.authorActions.editAuthor(this.props.match.params.id)
  }

  componentDidUpdate(prevProps) {    
    if (!this.props.error && this.props.author != prevProps.author) {
      let author = this.props.author.author
      this.setState({
        loading: false,
        name: author.name,
  ...
  handleUpdateClick () {
    ...
    this.props.authorActions.updateAuthor(this.props.match.params.id, formData)
  }
...
export default connect(
  state => ({
    ...
    reloading: state.default.services.author.reloading
  }),
  dispatch => ({
    authorActions: bindActionCreators({ updateAuthor, editAuthor }, dispatch)
  })
)(EditAuthor)
