...
import {
  getFeatureds,
  deleteFeatured
} from '../../services/featured/featuredActions'
...
class Featureds extends Component {
  constructor (props) {
    super(props)
    this.state = {
      loading: true,
  ...
  getAllList() {
    ...
    this.props.featuredActions.getFeatureds(params)
  }
  ...
  handleDelete (id) {
    this.props.featuredActions.deleteFeatured(id)
  }
    ...
    return (
      <div className='p-4 w-100 mt-70'>
        ...
        <Breadcrumbs aria-label='breadcrumb' className='w-100 mb-4'>
          ...
          <Typography color='textPrimary'>Featureds</Typography>
        </Breadcrumbs>
        {this.state.loading ? (
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align='center'>Pic Url</TableCell>
...
export default connect(
  state => ({
    featureds: state.default.services.featured.featureds,
    total_count: state.default.services.featured.total_count,
  ...
  dispatch => ({
    featuredActions: bindActionCreators({ getFeatureds, deleteFeatured }, dispatch),
