...
import { addFeatured, createFeatured } from '../../services/featured/featuredActions'
...
class AddFeatured extends Component {
  ...
  componentDidMount () {
    this.props.featuredActions.createFeatured()
  }
  ...
  componentDidUpdate(prevProps) {    
    ...
    if (
      !this.props.error &&
      this.props.featureds.length != prevProps.featureds.length
    ) {
      prevProps.history.push('/featured/featureds');
  ...
  handleCreateClick () {
    ...
    this.props.featuredActions.addFeatured(formData)
...
export default connect(
  ...
  dispatch => ({
    featuredActions: bindActionCreators({ addFeatured, createFeatured }, dispatch)
  })
)(AddFeatured)
