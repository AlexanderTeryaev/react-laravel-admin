...
import {
  getPlans,
  deletePlan
} from '../../services/plan/planActions'
...
class Plans extends Component {
  ...
  componentDidMount () {
    ...
    this.props.planActions.getPlans(params)
  }

  handleDelete (id) {
    this.props.planActions.deletePlan(id)
  }
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align='center'>Users Limit</TableCell>
                  ...
                  <TableBody>
                    {this.props.plans.map(row => (
                      <TableRow key={row.id} hover>
                        <TableCell component='th' scope='row'>
                          {row.name ? row.name : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
                          {row.features ? row.features : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
                          {row.price ? row.price : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
                          {row.users_limit ? row.users_limit : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
                          {row.plan_id ? row.plan_id : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
...
export default connect(
  state => ({
    ...
    total_count: state.default.services.plan.total_count,
  ...
  dispatch => ({
    planActions: bindActionCreators(
      { getPlans, deletePlan },
      dispatch
    )
  })
