...
class EditQuestion extends Component {
  ...
  componentDidMount () {
    this.props.questionActions.editQuestion(this.props.match.params.id)
  }
  ...
  componentDidUpdate (prevProps) {
    if (!this.props.error && this.props.question != prevProps.question) {
      ...
      let difficultyId
      this.props.question.difficulty_array.map((item, key) => {
      ...
      this.setState({
        ...
        author_id: question.author_id ? question.author_id : null,
        quizz_id: question.quizz_id ? question.quizz_id : null,
        more: question.more,
    ...
    if (
      ...
      this.props.history.push('/question/questions');
  ...
  renderQuizzesOptions () {
    return this.props.question.quizzes.map((dt, i) => {
      return (
        <MenuItem label='Select Quizz' value={dt.id} key={i} name={dt.name}>
          {dt.name}
        </MenuItem>
      )
    })
  ...
  renderAuthorsOptions () {
    return this.props.question.authors.map((dt, i) => {
      return (
        <MenuItem label='Select Author' value={dt.id} key={i} name={dt.name}>
          {dt.name}
        </MenuItem>
      )
    })
  ...
  handleUpdateClick () {
    ...
    this.props.questionActions.updateQuestion(this.props.match.params.id, formData)
