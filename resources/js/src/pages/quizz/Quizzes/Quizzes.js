...
import { getQuizzes } from '../../../services/quizz/quizzActions'
...
class Quizzes extends Component {
  ...
  getAllList() {
    ...
    this.props.quizzActions.getQuizzes(params)
  }
    ...
    return (
      <div className='p-4 w-100 mt-70'>
        ...
        <Breadcrumbs aria-label='breadcrumb' className='w-100 mb-4'>
          ...
          <Typography color='textPrimary'>Quizzes</Typography>
        </Breadcrumbs>
        {this.state.loading ? (
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align='center'>EnduroLimit</TableCell>
                      <TableCell align='center'>Author</TableCell>
                      <TableCell align='center'>Questions</TableCell>
                      <TableCell align='center'>Geolocalization</TableCell>
                  ...
                  <TableBody>
                    {this.props.quizzes.map(row => (
                      <TableRow key={row.id} hover>
                        ...
                        <TableCell align='center'>
                          {row.enduro_limit ? row.enduro_limit : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
                        ...
                        <TableCell align='center'>
                          {row.geolocalization ? row.geolocalization : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
                          {row.tags ? row.tags : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
                          {row.isPublished ? row.isPublished : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
                        ...
                        <TableCell align='center' className='d-flex'>
                          <IconButton aria-label='Edit'>
                            <Link to={'/quizz/edit/' + row.id}>
                              <EditIcon color='primary' />
                            </Link>
                          </IconButton>
                          <IconButton aria-label='Detail'>
                            <Link to={'/quizz/detail/' + row.id}>
...
export default connect(
  state => ({
    ...
    total_count: state.default.services.quizz.total_count,
  ...
  dispatch => ({
    quizzActions: bindActionCreators({ getQuizzes }, dispatch),
