...
class Reports extends Component {
  ...
  componentDidMount () {
    ...
    this.props.reportActions.getReports(params)
  }

  handleDelete (id) {
    this.props.reportActions.deleteReport(id)
                  ...
                  <TableBody>
                    {this.props.reports.map(row => (
                      <TableRow key={row.id} hover>
                        ...
                        <TableCell>
                          {row.question ? row.question.question : 'N/A'}
                        </TableCell>
                        <TableCell>
...
export default connect(
  state => ({
    ...
    total_count: state.default.services.report.total_count,
