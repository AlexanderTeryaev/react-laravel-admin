...
import { addShopAuthor, createShopAuthor } from '../../services/shopAuthor/shopAuthorActions'
import { toastr } from 'react-redux-toastr';

class AddShopAuthor extends Component {
  constructor (props) {
    super(props)
    this.state = {
      loading: false,
  ...
  componentDidUpdate(prevProps) {    
    if (
      !this.props.error &&
      this.props.shopAuthors.length != prevProps.shopAuthors.length
    ) {
  ...
  handleCreateClick () {
    ...
    this.props.shopAuthorActions.addShopAuthor(formData)
  }
...
export default connect(
  ...
  dispatch => ({
    shopAuthorActions: bindActionCreators({ addShopAuthor, createShopAuthor }, dispatch)
  })
)(AddShopAuthor)
