...
import { addShopImportQuestion } from '../../services/shopImportQuestion/shopImportQuestionActions'
import { toastr } from 'react-redux-toastr'

class AddShopImportQuestion extends Component {
  constructor (props) {
    super(props)
    this.state = {
      loading: false,
  ...
  componentDidUpdate (prevProps) {
    if (
      ...
      prevProps.history.push('/shop-import/questions')
    }
  ...
  handleCreateClick () {
    ...
    this.props.shopImportQuestionActions.addShopImportQuestion(formData)
  }
    ...
    return (
      <div className='mt-70 p-4 w-100'>
        ...
        <Breadcrumbs aria-label='breadcrumb' className='w-100 mb-4'>
          ...
          <Link color='inherit' href='/shop-import/questions'>
            Question Imports
          </Link>
...
export default connect(
  ...
  dispatch => ({
    shopImportQuestionActions: bindActionCreators({ addShopImportQuestion }, dispatch)
  })
