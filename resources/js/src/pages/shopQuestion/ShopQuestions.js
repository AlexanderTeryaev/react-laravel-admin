...
class ShopQuestions extends Component {
  constructor (props) {
    super(props)
    this.state = {
      loading: true,
  ...
  componentDidMount () {
    ...
    this.props.shopQuestionActions.getShopQuestions(params)
  }

  handleDelete (id) {
    this.props.shopQuestionActions.deleteShopQuestion(id)
  }
    ...
    return (
      <div className='p-4 w-100 mt-70'>
        ...
        <Breadcrumbs aria-label='breadcrumb' className='w-100 mb-4'>
          ...
          <Typography color='textPrimary'>Training Questions</Typography>
        </Breadcrumbs>
        {this.state.loading ? (
            ...
            <Grid item xs={12}>
              <Box>
                <Table>
                  ...
                  <TableBody>
                    {this.props.shopQuestions.map(row => (
                      <TableRow key={row.id} hover>
                        ...
                        <TableCell className='d-flex'>
                          ...
                          <IconButton aria-label='Edit'>
                            <Link to={'/shop-question/edit/' + row.id}>
...
export default connect(
  state => ({
    ...
    total_count: state.default.services.shopQuestion.total_count,
  ...
  dispatch => ({
    shopQuestionActions: bindActionCreators(
      { getShopQuestions, deleteShopQuestion },
      dispatch
    )
  })
)(ShopQuestions)