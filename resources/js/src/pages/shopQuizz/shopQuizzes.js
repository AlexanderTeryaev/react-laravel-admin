...
import { getShopQuizzes } from '../../services/shopQuizz/shopQuizzActions'
import { toastr } from 'react-redux-toastr'

class ShopQuizzes extends Component {
  constructor (props) {
    super(props)
    this.state = {
      loading: true,
  ...
  componentDidMount () {
    ...
    this.props.shopQuizzActions.getShopQuizzes(params)
  }
    ...
    return (
      <div className='p-4 w-100 mt-70'>
        ...
        <Breadcrumbs aria-label='breadcrumb' className='w-100 mb-4'>
          ...
          <Typography color='textPrimary'>Training Quizzes</Typography>
        </Breadcrumbs>
        {this.state.loading ? (
            ...
            <Grid item xs={12}>
              <Box>
                <Table>
                  ...
                  <TableBody>
                    {this.props.shopQuizzes.map(row => (
                      <TableRow key={row.id} hover>
                        <TableCell component='th' scope='row'>
                          {row.training ? row.training.name : 'N/A'}
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell className='d-flex'>
                          <IconButton>
                            <Link to={ '/shopQuizz/detail/' + row.id }>
                              <VisibilityIcon color='primary'/>
                            </Link>
                          </IconButton>
                          <IconButton aria-label='Edit'>
                            <Link to={'/shopQuizz/edit/' + row.id}>
...
export default connect(
  state => ({
    ...
    total_count: state.default.services.shopQuizz.total_count,
