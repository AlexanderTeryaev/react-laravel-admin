...
import { getUsers } from '../../../services/user/userActions'
...
class Users extends Component {
  ...
  componentDidMount () {
    ...
    this.props.userActions.getUsers(params)
  }
                  ...
                  <TableBody>
                    {this.props.users.map(row => (
                      <TableRow key={row.id} hover>
                        ...
                        <TableCell>
                          {row.device_id ? row.device_id : 'N/A'}
                        </TableCell>
                        <TableCell>
                          {row.last_ip ? row.last_ip : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
                          {row.curr_os ? row.curr_os : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
                          {row.curr_app_version ? row.curr_app_version : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
                          {row.subscriptionCount ? row.subscriptionCount : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
                          {row.answerCount ? row.answerCount : 'N/A'}
                        </TableCell>
                        <TableCell align='center'>
...
export default connect(
  state => ({
    users: state.default.services.user.users,
    total_count: state.default.services.user.total_count,
